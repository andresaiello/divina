...
export const CHAT_NEW_CHAT = gql`
  mutation createChatGroup ($author: String!, $caption: String!, $picUrl: [String!], $members: [String!]) {
    createChatGroup (author: $author, caption: $caption, picUrl: $picUrl, members: $members) {
      _id
      author{
        username
        profilePic
