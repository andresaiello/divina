...
module.exports = {
  serverRuntimeConfig: {
    ...
    MONGO_SERVER_URL: process.env.MONGO_SERVER_URL || 'mongodb://divinaapp:k6gbTKbThhKrD5b1@ds059692.mlab.com:59692/divina-app',
    ...
    AUTH0_CALLBACK_URL: process.env.AUTH0_CALLBACK_URL || `http://${host}:${process.env.PORT || PORT}/callback`,
